...
static const char *FSM_STATE_NAMES[FSM_STATE_LEN] = { "FSM_STATE_INIT", "FSM_STATE_WIFI_CONNECTION", "FSM_STATE_CHECK_CONFIG", "FSM_STATE_LOAD_CONFIG", "FSM_STATE_DISPLAY_UPDATE", "FSM_STATE_ERROR", "FSM_STATE_LEN" };
